...
var _luckynum7$elm_is_fun$Main$main = {
	main: _elm_lang$html$Html$text('Hello World!')
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _luckynum7$elm_is_fun$Main$main === 'undefined' ? null : _luckynum7$elm_is_fun$Main$main);
